...
ggsave(width = opts_current$get("fig.width"), height = opts_current$get("fig.height"), filename = "Figure1.tiff", dpi = 600)
```
...
ggsave(width = opts_current$get("fig.width"), height = opts_current$get("fig.height"), filename = "Figure2.tiff", dpi = 600)
```
...
ggsave(width = opts_current$get("fig.width"), height = opts_current$get("fig.height"), filename = "Figure3.tiff", dpi = 600)
```
...
ggsave(width = opts_current$get("fig.width"), height = opts_current$get("fig.height"), filename = "Figure4.tiff", dpi = 600)
```
...
ggsave(width = opts_current$get("fig.width"), height = opts_current$get("fig.height"), filename = "Figure5.tiff", dpi = 600)
```
...
ggsave(width = opts_current$get("fig.width"), height = opts_current$get("fig.height"), filename = "Figure6.tiff", dpi = 600)
```
...
ggsave(width = opts_current$get("fig.width"), height = opts_current$get("fig.height"), filename = "Figure7.tiff", dpi = 600)
```
